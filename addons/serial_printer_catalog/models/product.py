...
class ProductTemplate(models.Model):
    ...
    def sync_product_from_api(self):
        ...
        template_vals = {
            'name': full_name,
            'default_code': default_code,  # 👈 Este es el Internal Reference SIEMPRE
            'type': 'consu',
            'is_storable': True,
    ...
    def sync_stock_from_api(self):
        ...
        # Busca el template por default_code

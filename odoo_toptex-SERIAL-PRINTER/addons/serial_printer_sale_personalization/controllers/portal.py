...
class SerialPrinterPersonalizationPortal(http.Controller):
    ...
    def _save_marking_from_post(self, personalization, post):
        """Guarda un marcaje completo desde el formulario público.

        Se mantiene aislado para que lo pueda usar tanto el botón Guardar de cada marcaje
        como el envío final de la ficha mediante guardado previo por JavaScript.
        """
        ...
        new_position = self._selection_value(

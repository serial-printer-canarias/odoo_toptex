...
class SpPersonalizationGroup(models.Model):
    ...
    def _compute_product_image_data_uri(self):
        for group in self:
            group.product_image_data_uri = _data_uri_from_b64(group.product_image_1920)
    ...
    def _compute_logo_preview_available(self):
        for rec in self:
            ...
            if attachment and attachment.datas:
                data_uri = _data_uri_from_b64(attachment.datas, attachment.mimetype)
            elif rec.preview_image:
                data_uri = _data_uri_from_b64(rec.preview_image)
